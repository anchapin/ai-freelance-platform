...
class TestEscalationTransactions:
    ...
    @pytest.mark.asyncio
    async def test_task_status_updated_even_if_notification_fails(
...
class TestHighValueTaskNotifications:
    ...
    @pytest.mark.asyncio
    async def test_low_value_task_skips_notification(
        self, mock_db, sample_low_value_task
    ):
...
class TestEscalationErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_notification_failure_logged_but_not_raised(
        self, mock_db, sample_task
    ):
...
class TestIdempotencyKey:
    ...
    @pytest.mark.asyncio
    async def test_same_task_different_reason_creates_new_log(
        self, mock_db, sample_task
    ):
