...
class TestPerformanceTracker:
    ...
    def test_get_handler_recommendations(self):
        ...
        llama_rec = next((r for r in recommendations if r["handler"] == "llama-3.2"), None)
...
class TestIntelligentRouter:
    ...
    def test_calculate_complexity_score(self, intelligent_router):
        ...
        score2 = intelligent_router._calculate_complexity_score(
            ...
            ["date", "sales", "region", "product", "customer_type", "channel", "price", "cost", "profit"],
            "data_analysis"
        )
    ...
    def test_calculate_success_rate(self, intelligent_router):
        ...
        rate1 = intelligent_router._calculate_success_rate("data_analysis", "visualization", "image")
    ...
    async def test_route_legal_task(self, intelligent_router):
        ...
        routing_decision = result["routing_decision"]
        assert routing_decision.handler_type in ["legal_specialist", "document_generator"]
    ...
    async def test_route_accounting_task(self, intelligent_router):
        ...
        routing_decision = result["routing_decision"]
        assert routing_decision.handler_type in ["accounting_specialist", "spreadsheet_generator"]
    ...
    def test_retrain_classifier(self, intelligent_router, mock_db_session):
        ...
        mock_db_session.query.return_value.filter.return_value.limit.return_value.all.return_value = [mock_task]
    ...
    async def test_fallback_handling(self, intelligent_router):
        ...
        # Patch the execution methods
        with patch.object(intelligent_router, '_execute_standard_task', side_effect=failing_handler), \
             patch.object(intelligent_router, '_execute_visualization_task', side_effect=successful_handler):
...
def create_test_task_profile(domain: str = "data_analysis", complexity: float = 0.5) -> TaskProfile:
